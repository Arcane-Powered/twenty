...
import { AddEmailAssistantSettingsToWorkspaceFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-41/2-41-instance-command-fast-1789237546598-add-email-assistant-settings-to-workspace';
...
export const INSTANCE_COMMANDS = [
  ...
  AddEmailAssistantSettingsToWorkspaceFastInstanceCommand,
];
