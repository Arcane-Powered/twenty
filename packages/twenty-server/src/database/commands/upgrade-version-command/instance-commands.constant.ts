...
import { AddEmailAssistantSettingsToWorkspaceFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-43/2-43-instance-command-fast-1790337752239-add-email-assistant-settings-to-workspace';
