...
export const fromWorkspaceEntityToFlat = (
  ...
  aiEmailInstructions: entity.aiEmailInstructions,
  aiEmailTone: entity.aiEmailTone,
  aiEmailLanguage: entity.aiEmailLanguage,
  aiEmailLength: entity.aiEmailLength,
  isAiEmailAutoSummaryEnabled: entity.isAiEmailAutoSummaryEnabled,
