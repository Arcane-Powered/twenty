export enum SettingsPath {
  ...
  ApplicationPublicDomainNew = 'applications/:applicationId/public-domain/new',
  ApplicationPublicDomainDetail = 'applications/:applicationId/public-domain/:publicDomainId',
